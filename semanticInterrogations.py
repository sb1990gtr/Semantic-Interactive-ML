# -*- coding: utf-8 -*-
"""
Created on Sat Dec 11 16:32:36 2021

@author: Mareike Hoffmann
"""
#README: Implementation of Semantic Interrogation Approach to create new training examples
#A destructive and a constructive document creation is implemented for both lime and topiclime
#A further implementation for topiclime takes deeper expert knowledge into account by determine the topic distribution
...
def LIME_SI_const(global_id, query_inst, learner, alpha, num_docs,num_words_per_doc):
    ...
    #lime = LIME_explainer(global_id, query_inst, learner,len_explanation, expl_for_true_label=False)
...
#Semantic Interrogation approach - correction
...
def SI_correct(global_id, prediction, query_inst, learner, alpha, num_docs, size_new_textpart, gs_weight):
    ...
    #topics_positive_not_in_doc = list(set(positive_topics) - set(positive_topics_in_document))
    #print("positive topics not in doc: ", topics_positive_not_in_doc)
...
#Semantic Interrogation approach - constructive
